...
class AuthServiceIntegrationTest {
    ...
    void register_ShouldCreateUser_WhenDataIsValid() {
        ...
        assertThat(response.getEmail()).isEqualTo("integration.test@unicauca.edu.co");
    ...
    void login_ShouldReturnUser_WhenCredentialsAreValid() {
        ...
        assertThat(response.getUser().getEmail()).isEqualTo("login.test@unicauca.edu.co");
    ...
    void getProfile_ShouldReturnUser_WhenUserExists() {
        ...
        assertThat(profile.getEmail()).isEqualTo("profile.test@unicauca.edu.co");
    }
